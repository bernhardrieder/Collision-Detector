...
void SimpleMovable2D::SetPosition(const Vector3& newPosition)
{
...
void SimpleMovable2D::SetScale(const Vector3& newScale)
{
...
void SimpleMovable2D::move(const Vector3& normalizedDirectionVector, const float& speed, const float& deltaTime)
{
